...
public class LinkHeaderParserTest {
    ...
    public void testFullHeader() {
        ...
        Assert.assertEquals(first, lhp.getFirst());
        Assert.assertEquals(prev, lhp.getPrevious());
        Assert.assertEquals(last, lhp.getLast());
        Assert.assertEquals(next, lhp.getNext());
        Assert.assertEquals(true, lhp.hasLinkHeader());
    }
    ...
    public void testEmptyHeader() {
        ...
        Assert.assertEquals(last, lhp.getLast());
        Assert.assertEquals(next, lhp.getNext());
        Assert.assertEquals(false, lhp.hasLinkHeader());
    }
    ...
    public void testDebug() {
        ...
        Assert.assertEquals("Page 7 of 100", text);
    }
