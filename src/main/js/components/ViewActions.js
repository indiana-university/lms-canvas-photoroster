...
const ViewActions = (props) => {
    ...
    if (props.showSignInView) {
        signInMarkup = (
            <div className="rvt-p-left-xs">
                <a href="#" onClick={handleViewChange.bind(this, VIEW_MODES.signIn)} title="Sign-In Sheet View">
    ...
    return (
        <div className="rvt-display-flex rvt-p-top-xs rvt-vertical-center">
            <div>
                <a onClick={handleViewChange.bind(this, VIEW_MODES.grid)} href="#" title="Grid View">
            ...
            <div className="rvt-p-left-xs">
                <a href="#" onClick={handleViewChange.bind(this, VIEW_MODES.list)} title="List View">
