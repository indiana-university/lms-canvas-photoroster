...
const ViewActions = (props) => {
    ...
    if (props.showSignInView) {
        signInMarkup = (
            <div className="rvt-p-left-xs">
                <button className="view-option rvt-button rvt-button--secondary" onClick={handleViewChange.bind(this, VIEW_MODES.signIn)} title={signinTitle}>
    ...
    return (
        <div className="rvt-display-flex rvt-p-top-xs rvt-vertical-center">
            <div>
                <button className="view-option rvt-button rvt-button--secondary" onClick={handleViewChange.bind(this, VIEW_MODES.grid)} title={gridTitle} >
            ...
            <div className="rvt-p-left-xs">
                <button className="view-option rvt-button rvt-button--secondary" onClick={handleViewChange.bind(this, VIEW_MODES.list)} title={listTitle}>
